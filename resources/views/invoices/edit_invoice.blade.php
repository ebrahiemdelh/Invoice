                ...
                <div class="card-body">
                    <form action="{{ url('invoices/update') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col">
                                ...
                                <select name="section" id="section" class="form-control SlectBox"
                                    ...
                                    @foreach ($sections as $section)
                                        @if ($invoices->section_id === $section->id)
                                            <option value="{{ $section->id }}" selected> {{ $section->section_name }}
                                            </option>
                                        @else
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="discount"
                                    name="discount" title="يرجي ادخال مبلغ الخصم " value="{{ $invoices->discount }}"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value=0 required>
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="total" class="control-label">الإجمالي شامل الضريبة</label>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="note" name="note" rows="3" value="{{ $invoices->note }}"></textarea>
                            </div>
                        </div><br>
