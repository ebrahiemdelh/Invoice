...
@section('content')
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('invoicesdetails.show', $invoice->id) }}">{{ $invoice->section->section_name }}</a>
                                        </td>
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#"
                                                        ...
                                                        data-target="#Transfer_invoice"><i
                                                            class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;إستعادة
                                                        الفاتورة</a>
                                                    {{-- @endcan --}}
                                                    {{-- @can('حذف الفاتورة') --}}
                                                    <a class="dropdown-item" href="#"
    ...
    <div class="modal fade" id="Transfer_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">إستعادة الفاتورة</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <form action="{{ route('archive_invoices.store', 'test') }}" method="post">
                        @csrf
                </div>
                <div class="modal-body">
