...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الإعدادات</h4><span
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $products)
                                    <tr>
                                        ...
                                        <td>{{ $products->sections->section_name }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                ...
                                                data-section_name="{{ $products->section_name }}"
                                            ...
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                data-id="{{ $products->id }}"
                                                data-product_name="{{ $products->product_name }}"
                                                data-section_name="{{ $products->section_name }}" data-toggle="modal"
