...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/home') }}"><img
                src="{{ URL::asset('assets/img/brand/logo.png') }}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{ url('/home') }}"><img
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/OIP.jpg') }}"><span
                        class="avatar-status profile-status bg-green"></span>
                </div>
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">{{ Auth::user()->user }}</h4>
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الصفحة الرئيسة</span></a>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('invoices.show', 1) }}">الفواتير المدفوعة</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('invoices.show', 2) }}">الفواتير غير
                            المدفوعة</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('invoices.show', 3) }}">الفواتير
                            المدفوعة جزئياً</a></li>
                    <li><a class="slide-item" href="{{ route('archive_invoices.index') }}">الأرشيف</a></li>
                </ul>
            </li>
