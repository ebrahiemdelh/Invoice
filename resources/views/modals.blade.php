        ...
        <div class="col-sm-4 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-primary" data-target="#modaldemo1" data-toggle="modal" href="">View
                        Demo</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-secondary" data-target="#modaldemo2" data-toggle="modal" href="">View
                        Demo</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-info" data-target="#modaldemo3" data-toggle="modal" href="">View
                        Demo</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-warning" data-target="#modaldemo6" data-toggle="modal" href="">View
                        Demo</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-success" data-target="#modaldemo4" data-toggle="modal" href="">View
                        Demo</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-danger" data-target="#modaldemo5" data-toggle="modal" href="">View
                        Demo</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-teal" data-target="#select2modal" data-toggle="modal" href="">View
                        Demo</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-primary" data-target="#scrollingmodal" data-toggle="modal"
                        href="">View Demo</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-secondary" data-target="#scrollmodal" data-toggle="modal"
                        href="">View Demo</a>
                </div>
            </div>
        </div>
